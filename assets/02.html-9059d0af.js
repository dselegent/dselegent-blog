import{ab as n,G as s,H as a,ac as p}from"./framework-09305b5d.js";const e={},t=p(`<h1 id="_5-echarts-各个配置项详细说明总结" tabindex="-1"><a class="header-anchor" href="#_5-echarts-各个配置项详细说明总结" aria-hidden="true">#</a> 5.echarts 各个配置项详细说明总结</h1><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>theme <span class="token operator">=</span> <span class="token punctuation">{</span>
