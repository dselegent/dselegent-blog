import{ab as p,G as c,H as o,E as s,S as n,N as t,ac as a,W as i}from"./framework-09305b5d.js";const l={},u=a(`<h1 id="_13【class的语法】" tabindex="-1"><a class="header-anchor" href="#_13【class的语法】" aria-hidden="true">#</a> 13【Class的语法】</h1><h2 id="_1-类的由来" tabindex="-1"><a class="header-anchor" href="#_1-类的由来" aria-hidden="true">#</a> 1.类的由来</h2><p>JavaScript 语言中，生成实例对象的传统方法是通过构造函数。下面是一个例子。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">Point</span><span class="token punctuation">(</span><span class="token parameter">x<span class="token punctuation">,</span> y</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
